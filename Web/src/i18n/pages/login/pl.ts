...
export default {
	...
	mobile: {
		...
		msgText: 'Ważna informacja: zaleca się korzystanie z przeglądarki Google, Microsoft Edge w wersji 79.0.1072.62 lub nowszej oraz przeglądarki 360 w trybie szybkim',
	},
	scan: {
