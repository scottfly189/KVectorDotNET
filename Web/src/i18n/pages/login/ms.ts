export default {
	...
	mobile: {
		...
		msgText: 'Petua hangat: adalah disyorkan untuk menggunakan Google, Microsoft edge, versi 79.0.1072.62 dan ke atas pelayar, dan pelayar 360, sila gunakan mod kelajuan',
	},
	scan: {
