...
export default {
	...
	mobile: {
		...
		msgText: 'Tips hangat: disarankan untuk menggunakan Google, Microsoft edge, versi 79.0.1072.62 dan browser di atasnya, dan browser 360, silakan gunakan mode kecepatan',
	},
	scan: {
