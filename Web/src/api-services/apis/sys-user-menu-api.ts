...
export const SysUserMenuApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserMenuUserMenuIdListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultListInt64>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserMenuUserMenuListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultListMenuOutput>>> {
...
export const SysUserMenuApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserMenuUserMenuIdListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultListInt64>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserMenuUserMenuListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultListMenuOutput>> {
...
export class SysUserMenuApi extends BaseAPI {
     ...
     * @memberof SysUserMenuApi
     */
    public async apiSysUserMenuUserMenuIdListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultListInt64>> {
     ...
     * @memberof SysUserMenuApi
     */
    public async apiSysUserMenuUserMenuListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultListMenuOutput>> {
