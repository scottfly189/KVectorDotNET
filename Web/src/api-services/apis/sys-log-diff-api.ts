...
import { AdminNETResultSqlSugarPagedListSysLogDiff } from '../models';
import { AdminNETResultSysLogDiff } from '../models';
...
export const SysLogDiffApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogDiffDetailIdGet(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSysLogDiff>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogDiffPagePost(body?: PageLogInput, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogDiff>>> {
...
export const SysLogDiffApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogDiffDetailIdGet(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSysLogDiff>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogDiffPagePost(body?: PageLogInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogDiff>> {
...
export class SysLogDiffApi extends BaseAPI {
     ...
     */
    public async apiSysLogDiffDetailIdGet(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSysLogDiff>> {
     ...
     * @memberof SysLogDiffApi
     */
    public async apiSysLogDiffPagePost(body?: PageLogInput, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogDiff>> {
