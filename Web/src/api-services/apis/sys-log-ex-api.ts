...
import { AdminNETResultSqlSugarPagedListSysLogEx } from '../models';
import { AdminNETResultSysLogEx } from '../models';
...
export const SysLogExApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogExDetailIdGet(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSysLogEx>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogExPagePost(body?: PageExLogInput, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogEx>>> {
...
export const SysLogExApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogExDetailIdGet(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSysLogEx>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysLogExPagePost(body?: PageExLogInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogEx>> {
...
export class SysLogExApi extends BaseAPI {
     ...
     * @memberof SysLogExApi
     */
    public async apiSysLogExDetailIdGet(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSysLogEx>> {
     ...
     * @memberof SysLogExApi
     */
    public async apiSysLogExPagePost(body?: PageExLogInput, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysLogEx>> {
