...
export const SysNoticeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticePagePost(body?: PageNoticeInput, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNotice>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticePageReceivedPost(body?: PageNoticeInput, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNoticeUser>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticeUnReadListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultListSysNotice>>> {
...
export const SysNoticeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticePagePost(body?: PageNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNotice>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticePageReceivedPost(body?: PageNoticeInput, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNoticeUser>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysNoticeUnReadListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultListSysNotice>> {
...
export class SysNoticeApi extends BaseAPI {
     ...
     * @memberof SysNoticeApi
     */
    public async apiSysNoticePagePost(body?: PageNoticeInput, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNotice>> {
     ...
     * @memberof SysNoticeApi
     */
    public async apiSysNoticePageReceivedPost(body?: PageNoticeInput, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultSqlSugarPagedListSysNoticeUser>> {
     ...
     * @memberof SysNoticeApi
     */
    public async apiSysNoticeUnReadListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultListSysNotice>> {
