...
import { AdminNETResultListEnumEntity } from '../models';
import { AdminNETResultListEnumTypeOutput } from '../models';
/**
...
export const SysEnumApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysEnumEnumDataListGet(enumName: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultListEnumEntity>>> {
         ...
         * @throws {RequiredError}
         */
        async apiSysEnumEnumTypeListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultListEnumTypeOutput>>> {
...
export const SysEnumApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysEnumEnumTypeListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultListEnumTypeOutput>> {
...
export class SysEnumApi extends BaseAPI {
     ...
     * @memberof SysEnumApi
     */
    public async apiSysEnumEnumTypeListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultListEnumTypeOutput>> {
