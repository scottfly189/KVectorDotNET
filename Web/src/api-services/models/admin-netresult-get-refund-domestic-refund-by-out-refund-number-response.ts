 ...
 *
 * @export
 * @interface AdminNETResultGetRefundDomesticRefundByOutRefundNumberResponse
 */
export interface AdminNETResultGetRefundDomesticRefundByOutRefundNumberResponse {

    /**
     * 状态码
     *
     * @type {number}
     * @memberof AdminNETResultGetRefundDomesticRefundByOutRefundNumberResponse
     */
    code?: number;
