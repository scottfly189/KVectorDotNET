    ...
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center py-6">
        ...
        <div class="flex items-center space-x-4">
          ...
          <!-- 登录按钮 -->
          <a href="https://admin.projectzoom.com.au/" target="_self" class="hidden md:block border border-yellow-500 text-yellow-500 px-4 py-2 rounded-md hover:bg-yellow-500 hover:text-white">
            {{ $t('common.login') }}
          </a>
        </div>
